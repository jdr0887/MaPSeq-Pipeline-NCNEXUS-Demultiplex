package edu.unc.mapseq.messaging.ncnexus.demultiplex;
...
public class NCNEXUSDemultiplexMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSDemultiplexMessageListener.class);

    private String studyName;

    public NCNEXUSDemultiplexMessageListener() {
        super();
    }
