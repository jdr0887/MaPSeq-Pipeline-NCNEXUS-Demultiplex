...
import edu.unc.mapseq.workflow.ncnexus.demultiplex.NCNEXUSDemultiplexWorkflow;

public class NCNEXUSDemultiplexWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSDemultiplexWorkflowExecutorTask.class);
    ...
    public NCNEXUSDemultiplexWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCNEXUSDemultiplexWorkflow casavaWorkflow = new NCNEXUSDemultiplexWorkflow();
