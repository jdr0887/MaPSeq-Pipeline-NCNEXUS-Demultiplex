...
@Command(scope = "ncnexus-demultiplex", name = "run-workflow", description = "Run NCNEXUS demultiplex Workflow")
@Service
public class RunWorkflowAction implements Action {
    ...
    public Object execute() throws Exception {
        ...
        try {
            ...
            Destination destination = session.createQueue("queue/ncnexus.demultiplex");
