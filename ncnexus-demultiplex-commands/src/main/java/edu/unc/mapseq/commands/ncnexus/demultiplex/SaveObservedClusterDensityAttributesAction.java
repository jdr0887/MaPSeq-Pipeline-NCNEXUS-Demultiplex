package edu.unc.mapseq.commands.ncnexus.demultiplex;
...
@Command(scope = "ncnexus-demultiplex", name = "save-observed-cluster-density-attributes", description = "Save Observed Cluster Density Attributes")
@Service
